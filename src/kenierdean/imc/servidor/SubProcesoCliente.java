package kenierdean.imc.servidor;
...
import kenierdean.imc.modelo.CalculoImc;
import kenierdean.imc.vistas.VentanaPrincipal;
...
public class SubProcesoCliente extends Thread {
    ...
    public CalculoImc.Imc calcularImc() throws Exception {
        ...
        try {
            ...
            String msg = "Error al ontener datos del cliente " + ip;
            System.out.println(log() + msg);
            ventana.getCajaLog().append(log() + msg + "\n");
            throw new Exception("Error al obtener datos del cliente " + ip);
        }
    }
        ...
        Thread hiloResponde = new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    String msg = "Error al leer los datos del cliente " + ip;
                    System.out.println(log() + msg);
                    ventana.getCajaLog().append(log() + msg + "\n");
                    try {
                        cliente.close();
